package com.call.myapplication.Video.adapters;
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.rootLayout.setOnClickListener(v -> {
            ...
            for (int i = 0; i <selectedUsers.size() ; i++) {
                ...
                Log.i("tag","Log1 "+selectedUsers.get(i).getLogin());
                Log.i("tag","Log2 "+selectedUsers.get(i).getFullName()+"");
                Log.i("tag","Log3 "+selectedUsers.get(i).getId());
            }
